...
class ConnectFourBoard(object):
    ...
    def __init__(self, boardHeight=6, boardWidth=7, connectK=4, mcts_enabled=False, mcts_color=None, mcts_budget=70000):
...
#return self.mcts_game._legal(self.mcts_state, columnNumber)
    ...
    def update_mtcs_game(self, columnNumber, color):
        pass
        """
        if self.mcts_enabled and color != self.mcts_color:
            player = 0 if color == "R" else 1
